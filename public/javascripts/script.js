...
function exit(){
    ...
    sessionStorage.total = undefined;
     ...
     if (window.XMLHttpRequest){// code for IE7+, Firefox, Chrome, Opera, Safari
        ...
        xmlhttp.onreadystatechange=function(){
                if (xmlhttp.readyState==4 && xmlhttp.status==200){
                    ...
                    var data = JSON.parse(xmlhttp.responseText);
                    var totl;
                    if (sessionStorage.total!==undefined) {
                        console.log(sessionStorage.total);
                        ...
                        sessionStorage.total = sessionStorage.total =''+(prevprice+(1*nooforder.value*data.price));
                        ...
                        totl = ''+(1*nooforder.value*data.price);
                        console.log('total :'+totl);
